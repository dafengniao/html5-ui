...
$jssdk = new JSSDK("wxa6e5c6ac4ab1b807", "d4624c36b6795d1d99dcf0547af5443d");
...
<head>
  ...
  <meta name="format-detection" content="telephone=no"/>
    <script src="http://frstatic.qiniudn.com/wechat/js/plugins.min.js"></script>
...
<div class="wrap">
  <div class="page page-1">
    <div class="title"><?php echo $signPackage["appId"].'<br>';?>  <?php echo $signPackage["nonceStr"];?></div>
    <div class="subtitle"><?php echo $signPackage["timestamp"].'<br>';?> <?php echo $signPackage["signature"];?></div>
    <div class="arrow"></div>
  </div>
...
<audio id="app_bgm" src="http://frstatic.qiniudn.com/wechat/js/bigger.mp3" loop="true" autoplay></audio>
<script type="text/javascript" >
  var m_name = '2015';
  var img_url = 'http://frstatic.qiniudn.com/images/promo/jd-share2.jpg';
  var link = 'http://1.openh5.sinaapp.com';
  var desc_str = '诚邀各位设计师、合作伙伴参加。';
  ...
  var basePath = "http://frstatic.qiniudn.com/images/promo/coin/";
